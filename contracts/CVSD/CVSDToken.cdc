...
pub contract CVSDToken: FungibleToken {
    ...
    init() {
        self.AdminStoragePath = /storage/cvsdTokenAdmin
        self.MinterProxyPublicPath = /public/cvsdTokenMinterProxy
        self.MinterProxyStoragePath = /storage/cvsdTokenMinterProxy
